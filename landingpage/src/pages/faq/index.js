...
export function Faq () {
  ...
  <div className="page-content ">
              ...
              <section className="app1-header bg1" >
                {/* <div className="app1-header "> */}
                    <div className="container">
                        <div className="row align-items-center justify-content-between">
                            <div className="col-12 col-lg-6 mb-6 mb-lg-0">  
                            <Tilt perspective="3000" transitionSpeed="2000">  
                            <img src={require(`../../assets/images/faqx.png`)} alt="Image" className="img-fluid d-none d-sm-block" />
                            </Tilt>
                            </div>
                        
                    
                        <div className="col-12 col-lg-6 col-xl-5 mb-0">
                        <h2 className="mt-3 font-w-5 text-dark"><strong className="text-white">Indique </strong> a Luminus, <strong className="text-white">ajude</strong> seus contatos a terem o <strong className="text-white">melhor</strong> em planos de saúde e <strong className="text-white">ganhe de forma ilimitada!</strong></h2>
                ...
                <div className="container" >
                  ...
                  <div className="row align-items-center justify-content-between mb-10">
                    ...
                    <Tilt perspective="5000" transitionSpeed="3000">  
                      <img src={require(`../../assets/images/prancha2.png`)} alt="Image" className="img-fluid" />
                      </Tilt>
                    </div>
                  ...
                  <div className="row align-items-center justify-content-between mb-10">
                    <div className="col-12 col-lg-6 order-lg-1 mb-6 mb-lg-0">
                    <Tilt perspective="5000" transitionSpeed="3000">  
                      <img src={require(`../../assets/images/ganhos.svg`)} alt="Image" className="img-fluid" />
                    </Tilt>
                    </div>
                    <div className="col-12 col-lg-6 col-xl-5">
                      <div>
                      <h2> <span className="badge badge-primary-soft p-2 text-orange">
                        ...
                        <h2 className="mt-3 font-w-5 text-white"><strong className="text-orange">Ganhos ilimitados.</strong> Quanto mais você indicar mais poderá ganhar!</h2>
                        <p className="lead mb-0 text-white">*Rentabilidade terá variação de acordo com a modalidade e quantidade de pessoas na apólice.</p>
                      </div>
                    </div>
                  </div>
                </div>
