    ...
    render() {
        return ( 
            <div className="row align-items-center">
                 <div className="squares d-none d-sm-block lg-6">
                        <img className="img-1" src={require(`../../assets/images/Ellipse.png`)} />
                        <img className="img-2" src={require(`../../assets/images/Ellipse.png`)} />
                    </div>
                <div className="col-xl-4 col-lg-4 mb-8 mb-lg-0">
                    <div className={`px-4 py-7 rounded hover-translate text-center ${this.props.bgshadow}`}>
                        <div>
                            <img className="img-fluid" src={require(`../../assets/images/mobile.svg`)} alt="" />
                        </div>
                ...
                <div className="col-xl-4 col-lg-4 col-sm-6 mt-6 mt-sm-0">
                    <div className={`px-4 py-7 rounded hover-translate text-center ${this.props.bgshadow}`}>
                        <div>
                            <img className="img-fluid" src={require(`../../assets/images/savings.svg`)} alt="" />
                        </div>
