                                    ...
                                    <div className="row justify-content-between">
                                        <div className="col-lg-5 col-md-12">
                                            <div className="coming-soon">
                                                <h1 className="mt-4 mb-2 font-w-7">EM BREVE</h1>
                                                <p>Estamos em constante evolução, aguardem as novidades Luminus que estão por vir!</p>
                                                ...
                                                <div>
                                                    <h4 className="title z-index-1 mb-4">se inscreva</h4>
                                                    <div className="row">
